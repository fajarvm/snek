...
local function CreateConfigFrame()
    ...
    local enableLabel = f:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
    ...
    -- Timing
    local timingHeader = f:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
    timingHeader:SetPoint("TOPLEFT", 20, y)
    ...
    autoCheck:SetPoint("TOPLEFT", 26, y)
    ...
    -- Feedback & Minimap
    local feedHeader = f:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
    feedHeader:SetPoint("TOPLEFT", 20, y)
    feedHeader:SetText("Feedback & Minimap")
    y = y - 26

    local feedbackCheck = CreateFrame("CheckButton", nil, f, "UICheckButtonTemplate")
    feedbackCheck:SetPoint("TOPLEFT", 26, y)
    feedbackCheck:SetSize(24, 24)
    local feedbackLabel = f:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    ...
    minimapCheck:SetPoint("TOPLEFT", 26, y)
    minimapCheck:SetSize(24, 24)
    local minimapLabel = f:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    ...
    -- Control Keybindings
    local ctrlHeader = f:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
    ctrlHeader:SetPoint("TOPLEFT", 20, y)
    ...
    local function MakeBindRow(text, which, bindingName)
        ...
        label:SetPoint("TOPLEFT", 30, y)
        label:SetText(text)
        local bindLabel = f:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
    ...
    -- Key labels + bindings
    local keyHeader = f:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
    keyHeader:SetPoint("TOPLEFT", 20, y)
    ...
    help:SetPoint("BOTTOMLEFT", 20, 18)
    help:SetPoint("BOTTOMRIGHT", -20, 18)
    help:SetJustifyH("LEFT")
    help:SetText("Changes are saved automatically.")
...
local function BuildStub()
    ...
    version:SetText("Version 0.7.0  –  Sequence Next Enqueued Key")
